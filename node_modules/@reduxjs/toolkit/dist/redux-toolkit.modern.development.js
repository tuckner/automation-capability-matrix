...
var createPause = (signal) => {
    return (promise2) => {
        return catchRejection(Promise.race([promisifyAbortSignal(signal), promise2]).then((output) => {
...
var autoBatchEnhancer = (options = { type: "raf" }) => (next) => (...args) => {
    ...
    const queueCallback = options.type === "tick" ? queueMicrotaskShim : options.type === "raf" ? requestAnimationFrame : options.type === "callback" ? options.queueNotification : createQueueWithTimer(options.timeout);
